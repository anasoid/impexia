...
public interface ImpexiaImportingService<
  ...
  T getExecutor(HeaderReader headerReader, Customizer<B> settingsCustomizer, List<String> configs);

  T getExecutor(HeaderReader headerReader, S settings);
}
