...
public class PrepareHeaderDataModelTransformer
    implements MonoTransformer<ImpexHeader, JpaImportingImpexContext> {

  @Override
  public ImpexHeader transform(ImpexHeader impexHeader, JpaImportingImpexContext ctx) {
    return null;
  }
